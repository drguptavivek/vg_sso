...
<#elseif client?? && client.rootUrl?? && client.rootUrl?has_content>
    <#assign appReturnUrl=client.rootUrl>
</#if>
            ...
            <#if realm.password>
                <form id="kc-form-login" onsubmit="login.disabled = true; return true;" action="${url.loginAction}" method="post">
                    ...
                    <div class="${properties.kcFormGroupClass!} ${properties.kcFormSettingClass!}">
                      ...
                      <#if appReturnUrl?has_content>
                          <div class="vg-login-cancel">
                              <a tabindex="8" href="${appReturnUrl}">${msg("backToApplication")}</a>
                          </div>
                      </#if>
                </form>
            </#if>
